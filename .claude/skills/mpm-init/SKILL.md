---
name: mpm-init
description: Initialize a new MPM project — scan, define Project+Phase, create ADV documents, set up Goals and Tasks.
---

# Initialize MPM Project

This skill walks through the full PPGT+ADV initialization in layer order.
Each layer must be completed before proceeding to the next.

---

## Layer 1: Project + Phase
...
## Layer 2: Foundation Documents (ADV)
...
Based on the Phase definition and ADV documents:
