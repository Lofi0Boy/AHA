...
Re-run loop: invoke /mpm-plan-design-review again → re-rate → sections at 8+ get a quick pass, sections below 8 get full treatment.
...
- If eng review has not been run: recommend `/mpm-plan-eng-review`
- If fundamental product direction gaps were found (initial score below 4/10, major IA problems): consider `/mpm-plan-ceo-review`
- The user can update `.mpm/docs/DESIGN.md` based on the design decisions made during this review.
