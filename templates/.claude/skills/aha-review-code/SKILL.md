...
> - **`.aha/docs/ARCHITECTURE.md`** — primary criteria for code structure, patterns, conventions.
> - **`.aha/docs/PROJECT.md`** — product vision. Code that works but doesn't serve the product direction should be flagged.
> - **`.aha/docs/VERIFICATION.md`** — check if the dev used the correct verification methods.
