...
> - **`.aha/docs/VERIFICATION.md`** — project-specific verification tools and exact commands. Use these, do not guess commands.
> - **`.aha/docs/PROJECT.md`** — product vision and target users. A feature that "works" but contradicts the product direction is a FAIL.
