...
echo "## [AHA] Project Context"
echo ""

# --- 1. AHA workflow ---
WORKFLOW="$CWD/.aha/aha-workflow.md"
if [[ -f "$WORKFLOW" ]]; then
  echo "###" "aha-workflow.md"
  cat "$WORKFLOW"
  echo ""
fi

# --- 2. Current task ---
CURRENT_FILE="$CWD/.aha/data/current/${SESSION_ID}.json"
...
# --- 4. Feedback history ---
FEEDBACK="$CWD/.aha/data/FEEDBACK_HISTORY.md"
if [[ -f "$FEEDBACK" ]]; then
